> This is a progressive webapp created using Polymer(Webcomponents). This is my first attempt to create a simple utility app. Which is lightweight, works offline and trustworthy.
